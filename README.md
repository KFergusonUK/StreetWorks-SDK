...
Map showing areas included in the SDK (Green - Open / Orange - Registration) as of 09 Aug 2026.
...
(sandbox-verified, not production), a UK-first `works_near` join pattern
over a documented four-provider subset (deliberately example code, not
an SDK export — see [`docs/concepts/common-model.md`](docs/concepts/common-model.md)),
two cross-provider comparisons/maps, a real-time AV last-mile router that
reroutes around live roadworks, and two visual showcases (a lone-worker
crime-context map, an OS Open USRN
