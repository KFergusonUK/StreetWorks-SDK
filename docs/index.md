...
- **Concepts** — [architecture](concepts/architecture.md), [data model](concepts/data-model.md), [using the common model](concepts/common-model.md), [data integrity discipline](concepts/data-integrity.md), [CRS & datums](concepts/crs-and-datums.md), [write path (Section 50)](concepts/write-path.md)
- **Providers** — [index / coverage matrix / credentials wanted](providers/index.md), [UK & Crown Dependencies](providers/uk.md), [Europe](providers/europe.md), [Italy](providers/italy.md), [Switzerland](providers/switzerland.md), [Austria](providers/austria.md), [Portugal](providers/portugal.md), [Ireland](providers/ireland.md), [Gibraltar](providers/gibraltar.md), [Iceland](providers/iceland.md), [Finland](providers/finland.md), [Greece](providers/greece.md), [Denmark](providers/denmark.md), [United States](providers/us.md), [Canada](providers/canada.md), [Australia](providers/australia.md), [New Zealand](providers/new-zealand.md), [pending candidates](providers/pending.md)
