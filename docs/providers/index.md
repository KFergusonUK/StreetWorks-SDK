...
| `streetworks.arcgis` | [Jersey RoadWorkx](https://roadworks.gov.je/) (roadworks) and its real [Jersey Street Gazetteer](https://roadworks.gov.je/) sibling, [Guernsey Street Gazetteer](https://roadworks.gov.gg/) (both streets, licence unconfirmed, confirmed live 2026-08-16), and [TIGERweb](https://tigerweb.geo.census.gov/) (US Census Bureau road segments, public domain) — a reusable ArcGIS REST Feature/Map Service client underneath, not provider-specific (no credentials for any) | read |
