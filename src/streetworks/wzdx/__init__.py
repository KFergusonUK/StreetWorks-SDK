...
A parser for WZDx GeoJSON road events (v3.1-v4.2, version-tolerant, and
CWZ 1.0 - the related AASHTO/ITE/NEMA/SAE standard built on WZDx v4.2 -
including one real vendor's camelCase field-naming quirk), a generic
client that fetches any agency's feed URL (WZDx is published
