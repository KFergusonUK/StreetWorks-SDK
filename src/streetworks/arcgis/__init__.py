...
:mod:`streetworks.arcgis.tigerweb` (streets) and
:mod:`streetworks.arcgis.dc` (roadworks, Washington DC) are its real
consumers so far; keep new code here generic so a future ArcGIS source
